...
/** A bending orthogonal move, paid for out of the go's squares. */
export function MoveDiagram() {
  ...
  return (
    <Figure
      ...
      caption="Spend squares from your go's six to move a unit — orthogonally, turning corners if you like, but never diagonally."
      height={oy + n * cell + 8}
    >
